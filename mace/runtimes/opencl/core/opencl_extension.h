...
#ifndef MACE_RUNTIMES_OPENCL_CORE_OPENCL_EXTENSION_H_
#define MACE_RUNTIMES_OPENCL_CORE_OPENCL_EXTENSION_H_
...
#endif  // MACE_RUNTIMES_OPENCL_CORE_OPENCL_EXTENSION_H_
