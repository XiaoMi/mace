...
#ifndef MACE_RUNTIMES_OPENCL_TRANSFORM_IMAGE_TO_BUFFER_H_
#define MACE_RUNTIMES_OPENCL_TRANSFORM_IMAGE_TO_BUFFER_H_
...
#endif  // MACE_RUNTIMES_OPENCL_TRANSFORM_IMAGE_TO_BUFFER_H_
