...
#ifndef MACE_RUNTIMES_QNN_QNN_RUNTIME_H_
#define MACE_RUNTIMES_QNN_QNN_RUNTIME_H_
...
class QnnRuntime : public QnnBaseRuntime {
 public:
  explicit QnnRuntime(RuntimeContext *runtime_context);
...
#endif  // MACE_RUNTIMES_QNN_QNN_RUNTIME_H_
