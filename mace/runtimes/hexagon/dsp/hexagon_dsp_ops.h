...
#ifndef MACE_RUNTIMES_HEXAGON_DSP_HEXAGON_DSP_OPS_H_
#define MACE_RUNTIMES_HEXAGON_DSP_HEXAGON_DSP_OPS_H_
...
#undef DEF_OP
  ...
  int GetOpId(const std::string &op_type) {
    if (op_map_.find(op_type) != end(op_map_)) {
      ...
      LOG(FATAL) << "Unsupported DSP op type: " << op_type;
...
#endif  // MACE_RUNTIMES_HEXAGON_DSP_HEXAGON_DSP_OPS_H_
