...
#ifndef MACE_RUNTIMES_HEXAGON_HTA_HEXAGON_HTA_TRANSFORMER_H_
#define MACE_RUNTIMES_HEXAGON_HTA_HEXAGON_HTA_TRANSFORMER_H_
...
class BaseTransformer {
 public:
  ...
  virtual void Init(Runtime *runtime) { runtime_ = runtime; }
...
#endif  // MACE_RUNTIMES_HEXAGON_HTA_HEXAGON_HTA_TRANSFORMER_H_
