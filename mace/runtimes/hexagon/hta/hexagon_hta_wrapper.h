...
#ifndef MACE_RUNTIMES_HEXAGON_HTA_HEXAGON_HTA_WRAPPER_H_
#define MACE_RUNTIMES_HEXAGON_HTA_HEXAGON_HTA_WRAPPER_H_
...
class CpuIonAllocator;
class HexagonHtaRuntime;
...
class HexagonHTAWrapper : public HexagonControlWrapper {
 public:
  explicit HexagonHTAWrapper(Runtime *runtime, std::shared_ptr<Rpcmem> rpcmem);
  ...
  bool ExecuteGraphNew(const std::map<std::string, Tensor *> &input_tensors,
                       std::map<std::string,
                                Tensor *> *output_tensors) override;
...
#endif  // MACE_RUNTIMES_HEXAGON_HTA_HEXAGON_HTA_WRAPPER_H_
