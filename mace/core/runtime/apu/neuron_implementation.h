...
#ifndef MACE_CORE_RUNTIME_APU_NEURON_IMPLEMENTATION_H_
#define MACE_CORE_RUNTIME_APU_NEURON_IMPLEMENTATION_H_
...
#endif  // MACE_CORE_RUNTIME_APU_NEURON_IMPLEMENTATION_H_
