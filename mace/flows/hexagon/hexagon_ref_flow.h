...
#ifndef MACE_FLOWS_HEXAGON_HEXAGON_REF_FLOW_H_
#define MACE_FLOWS_HEXAGON_HEXAGON_REF_FLOW_H_
...
class HexagonRefFlow : public CommonFp32Flow {
 public:
  explicit HexagonRefFlow(FlowContext *flow_context);
  virtual ~HexagonRefFlow() = default;
 ...
 private:
  MACE_DISABLE_COPY_AND_ASSIGN(HexagonRefFlow);
};

}  // namespace mace

#endif  // MACE_FLOWS_HEXAGON_HEXAGON_REF_FLOW_H_
