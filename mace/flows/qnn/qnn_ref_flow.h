...
#ifndef MACE_FLOWS_QNN_QNN_REF_FLOW_H_
#define MACE_FLOWS_QNN_QNN_REF_FLOW_H_
...
class QnnRefFlow : public CommonFp32Flow {
 public:
  explicit QnnRefFlow(FlowContext *flow_context);
  virtual ~QnnRefFlow() = default;
 ...
 private:
  MACE_DISABLE_COPY_AND_ASSIGN(QnnRefFlow);
};

}  // namespace mace

#endif  // MACE_FLOWS_QNN_QNN_REF_FLOW_H_
