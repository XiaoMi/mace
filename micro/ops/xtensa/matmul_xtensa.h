...
#ifndef MICRO_OPS_XTENSA_MATMUL_XTENSA_H_
#define MICRO_OPS_XTENSA_MATMUL_XTENSA_H_

#include "micro/framework/operator.h"

namespace micro {
namespace ops {
class MatMulXtensaOp : public framework::Operator {
 public:
  MaceStatus OnInit();
  MaceStatus Run();
...
#endif  // MICRO_OPS_XTENSA_MATMUL_XTENSA_H_
